...
namespace CrocoManager.Core.Services
{
    public sealed class SupabaseAuthService : IAuthService
    {
        ...
        public SupabaseAuthService(ISupabaseClientService supabase, ISecureStorageService secureStorage)
        {
            _supabase = supabase;
        ...
        public async Task<SupabaseSession?> RegisterAsync(string email, string password)
        {
            try
            {
                ...
                await _secureStorage.SetAsync("supabase_session", sessionJson);
        ...
        private SupabaseSession BuildSession(Supabase.Gotrue.Session authResponse)
        {
            ...
            return new SupabaseSession
            {
                ...
                User = new Core.Models.User
                {
                    ...
                    UserMetadata = new Core.Models.UserMetadata
                    {
                        Role = role
                    }
                }
